...
final class MediaAdapter$ViewHolder$bindView$2 implements OnLongClickListener {
    ...
    MediaAdapter$ViewHolder$bindView$2(ViewHolder viewHolder, C0966b c0966b, SimpleActivity simpleActivity, C0965a c0965a, int i) {
...
/*
        Error: jadx.core.utils.exceptions.DecodeException: Load method exception in method: com.simplemobiletools.gallery.adapters.MediaAdapter$ViewHolder$bindView$2.onLongClick(android.view.View):boolean
...
*/
    ...
    L_0x0052:
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.simplemobiletools.gallery.adapters.MediaAdapter$ViewHolder$bindView$2.onLongClick(android.view.View):boolean");
    }
}
