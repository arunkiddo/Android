package com.example.arun.chatbotfinal;
...
import  com.example.arun.chatbotfinal.Adapter.CustomAdapter;
import com.example.arun.chatbotfinal.Helper.HttpDataHandler;
import com.example.arun.chatbotfinal.Models.ChatModel;
import com.example.arun.chatbotfinal.Models.SimsimiModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class SimsimiAPI extends AsyncTask<List<ChatModel>,Void,String> {
        ...
        protected String doInBackground(List<ChatModel>... params) {
            String url = String.format("http://sandbox.api.simsimi.com/request.p?key=%s&lc=en&ft=1.0&text=%s",getString(R.string.simsimi_name),text);
            models = params[0];
